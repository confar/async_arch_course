...
from task_manager.app.core.tasks.models import Worker
from task_manager.app.core.tasks.repositories import TaskRepository, TaskEventRepository
...
class TaskService:
    ...
    def create_task(self, creator_id: int, description: str, assignee: Worker):
    ...
    def complete_task(self, worker: Worker, task_id: int):
    ...
    def assign_tasks(self, user: User):
